...
const historiqueAchatContoller = require("../controllers/historiqueAchatContoller")
...
const initWebRoutes = (app) => {
    ...
    router.get("/historique-achat", loginController.checkLoggedIn, historiqueAchatContoller.achatHistorique)
